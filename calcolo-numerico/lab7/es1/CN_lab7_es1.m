...
fprintf('Intervalli di ampiezza H: %d\n\n', m);
...
plot(xint_t, yint_t, '-go', 'LineWidth', 2, 'MarkerEdgeColor', 'g', 'MarkerFaceColor', 'g', 'MarkerSize', 7);
...
% errore trapezi
err_trap = int_exact - int_t;

% errore simpson
err_sim = int_exact - int_s;

% Visualizzazione degli errori
disp('----------ERRORE----------')
fprintf('Valore esatto: %f\n', int_exact);
fprintf('Trapezi errore: %f\n', err_trap);
fprintf('Simpson errore: %f\n', err_sim);
